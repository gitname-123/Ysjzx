...
class foodmateLaw(object):
    ...
    def scheduler(self):
        column_list = [
            ("draft/gjcaoan", "食品伙伴网-法规草案-国家法规草案"),
            ("draft/dfcaoan", "食品伙伴网-法规草案-地方法规草案"),
            ("draft/qtcaoan", "食品伙伴网-法规草案-其他法规草案"),
        ]
    ...
    def get_detail(self):
        ...
        while True:
            ...
            try:
                ...
                F_发布文号_xpath = response_html.xpath('//th[contains(text(), "发布文号")]/following-sibling::td[1]/text()')
                ...
                F_截止日期_xpath = response_html.xpath('//th[contains(text(), "截止日期")]/following-sibling::td[1]/a/text()')
                F_截止日期 = F_截止日期_xpath[0].strip() if F_截止日期_xpath else ""

                F_地区_xpath = response_html.xpath('//th[contains(text(), "地区")]/following-sibling::td[1]/text()')
                F_地区 = F_地区_xpath[0].strip() if F_地区_xpath else ""
